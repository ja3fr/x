...
export default function AuthForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        navigate(role === "ADMIN" ? "/admin/dashboard" : "/etudiant/demande");
      } else {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-cover bg-center bg-no-repeat">
      <div className="bg-white p-8 rounded-xl shadow-lg w-[200x] h-[658px]">
        <div className="text-center mb-4">
          <img src="logoEnicar.jpg" className="mx-auto w-[224px] h-[102px] mt-8" />
          <h2 className="text-xl font-semibold">Enicarthage Aide</h2>
          <p className="text-gray-600 mb-4">Bienvenue sur Enicarthage Aide</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-[595px] bg-blue-600 h-[50px] text-white py-2 rounded-lg hover:bg-blue-700"
          >
            Se connecter
          </button>
        </form>
